        ...
        if (!c("#" + b.id)[0]) {
            ...
            a.vessel(j, function (d, e) {
                c("body").append(d[0]), j ? function () {
                    2 == b.type || 4 == b.type|| 5 == b.type ? function () {
                        c("body").append(d[1])
                    }() : function () {
                    	var iparents;
                    	if(i.parents){
                    		iparents=i.parents("." + h[0])[0];
                    	}
                    	iparents|| (i.show().addClass("layui-layer-wrap").wrap(d[1]), c("#" + h[0] + g).find("." + h[5]).before(e))
                    }()
