...
function dropSidebarShadow() {
	...
	t < 130 ? $(".sidebar-footer").addClass("drop-shadow") : $(
...
function widthFunctions(e) {
	...
	var t = $(".navbar").outerHeight(), n = $("footer").outerHeight(), r = $(
			window).height(), i = $(window).width();
...
$(document)
		.ready(
				function(e) {
					...
					e("#main-menu-toggle").click(
							
							function() {
								//alert(11);
								e("body").hasClass("sidebar-hide") ? e("body")
										.removeClass("sidebar-hide")
										: e("body").addClass("sidebar-hide");
										
										var height = screen.availHeight-$("#navbar").height()-$("#row").height()-180;
										e("#home").css("height", height);
										var width = $("#main").width();
										e("#home").css("width", width);		
							});
...
$(document).ready(
		function(e) {
			...
			e('[rel="popover"],[data-rel="popover"],[data-toggle="popover"]')
					.popover();
			e(".btn-close").click(function(t) {
				t.preventDefault();
				e(this).parent().parent().parent().fadeOut()
			});
			e(".btn-minimize").click(
					function(t) {
						t.preventDefault();
						var n = e(this).parent().parent().next(".panel-body");
						n.is(":visible") ? e("i", e(this)).removeClass(
