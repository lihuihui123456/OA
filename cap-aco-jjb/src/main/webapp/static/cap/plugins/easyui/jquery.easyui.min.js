...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"正在加载, 请稍等 ...",rownumbers:false,singleSelect:false,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowEvents:{mouseover:_64b(true),mouseout:_64b(false),click:_653,dblclick:_65d,contextmenu:_661},rowStyler:function(_7fd,_7fe){
		...
		buttons : [
				{
					...
					text : function(_abd) {
						return $(_abd).datebox("options").cleanText;
					},
					handler : function(_abd) {
						$(_abd).datebox("setValue", "").datebox("setText", ""); // 设置空值
					$(_abd).datebox("hidePanel"); // 点击清空按钮之后关闭日期选择面板
				}
				}, {
					text : function(_abd) {
...
_ac6(this,q);
				...
				buttons : [ {
					...
					text : function(_abd) {
						return $(_abd).datetimebox("options").cleanText;
					},
					handler : function(_abd) {
						$(_abd).datetimebox("setValue", "").datetimebox("setText", ""); // 设置空值
					$(_abd).datetimebox("hidePanel"); // 点击清空按钮之后关闭日期选择面板
				}
				}, {
					text : function(_ade) {
