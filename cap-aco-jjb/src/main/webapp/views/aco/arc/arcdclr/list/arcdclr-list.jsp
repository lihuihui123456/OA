...
<script src="${ctx}/views/aco/arc/arcdclr/list/js/arcdclr-list.js"></script>
...
<script type="text/javascript">
	 ...
	 */
	 function expExcel(){
			//判断是否有选中
			var obj = $('#arcDclrList').bootstrapTable('getSelections');
			if (obj.length!=''||obj.length==1) {
				...
				$("#selectIds").val("");
					...
					if($("#input-word").val()!="请输入项目名称查询"&&$("#input-word").val()!=""){
					 ...
					 window.location.href = "${ctx}/arcDclrController/exportDclrExcel?"+$("#search_form").serialize();
					if($("#input-word").val()!="请输入项目名称查询"&&$("#input-word").val()!=""){
						 $("#sproName").val("");
					}	
	 }
...
<body>
	...
	<div style="padding-top: 0px;padding-bottom:0px;border:0;overflow-x:auto;overflow-y:auto;">
	...
	<%-- 	<div id="" style="border:1px solid #ddd; background:#fff; padding:10px; padding-right:13%; margin-top: 10px" >
			<form class="form-horizontal" id="search_form"">
				...
				<div class="form-group">
					...
					<label class="control-label col-lg-2 col-lg-2 col-md-2 col-sm-2 col-xs-2">立项单位:</label>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						<input class="form-control input-sm" type="text" id="sproCom"
							name="proCom" placeholder="请输入立项单位" style="margin-left: -50px;">
					</div>
				</div>	
				<div class="form-group">
