...
<body class="paper-outer">
	<div class="paper-inner">
		<form id="arcDclrForm" name="arcDclrForm">
			<p class="tablestyle_title" style="font-size:25pt">申报课题档案登记单</p>
			...
			<table class="tablestyle" width="100%" border="0" cellspacing="0">
				...
				<tr>
					...
					<td>
							<div class="form-group">
							<input type="text" class="validate[required] form-control input" id="decMny" name="decMny">
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3">
						<div class="form-group">
							<select class="selectpicker select" id="expiryDate"
