...
<body class="paper-outer">
	<div class="paper-inner">
		<form id="mtgSummForm" name="mtgSummForm">
			...
			<table class="tablestyle" width="100%" border="0" cellspacing="0">
				<tr>
					...
					<td>
						<div id="treeDiv_draftDeptId_" class="treeDiv">
							...
							class="validate[required] select" name="draft_depart_name"
							type="text"
							style="width: 100%; height: 29px; border: 0;padding:7px 12px;"
					...
					<td>
						<div class="input-group date" style="width: 100%">
							<input type="text" id="regTime" name="regTime" value="${nowDate}"
								style="width: 100%"
								class="validate[required] form-control input"
					...
					<td>
						<div class="form-group">
							<select class="validate[required]  selectpicker select"
								id="arcType" name="arcType"  title="请选择">
							</select>
						</div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<div class="form-group date">
							<input type="text" id="amsTime" name="amsTime" value=""
				...
				<tr>
					...
					<td colspan="3">
						<div class="form-group">
							<select class="validate[required]  selectpicker select"
								id="expiryDate" name="expiryDate" value="0" title="请选择">
				...
				<!-- 				<tr>
					...
					<td colspan="3">
						<div class="input-group date" style="width: 100%">
							<input type="text" id="fileTime" name="fileTime" value=""
								style="width: 100%" class="form-control select"
								onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" />
						</div>
					</td>
...
<script src="${ctx}/views/aco/arc/mtgsumm/js/mtgSumm_form.js"></script>
</html>