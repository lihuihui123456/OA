		...
		<form id="arcPrjForm" name="arcPrjForm">
			...
			<table class="tablestyle" width="100%" border="0" cellspacing="0">
				...
				<tr>
					...
					<td colspan="3">
							<div class="form-group">
							<input type="text" class="validate[required] form-control input" id="prjName" name="prjName">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td colspan="3">
						<div class="form-group">
							<input type="text" class="validate[required] form-control input" id="prjAdd" name="prjAdd">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class="form-group">
							<input type="text" class="form-control input" id="prjNbr" name="prjNbr">
						</div>
					</td>
					<th>项目联系人</th>
					<td>
						<div class="form-group">
							<input type="text" class="form-control input" id="prjUser" name="prjUser">
						</div>
					</td>
				</tr>
				<tr>
