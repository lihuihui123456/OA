...
<body class="paper-outer">
	<div class="paper-inner">
		<form id="myFm">
			<p class="tablestyle_title" style="font-size:25pt">单位发文稿纸</p>
			<input type="hidden" id="bizId_" name="bizId_">
			<table class="tablestyle" width="100%" border="0" cellspacing="0">
				<tr>
					<th style="width: 16%;">发文字号<span class="star">*</span></th>
					<td style="width: 16%;">
						<div class="form-group">
							<input type="text" class="validate[required] form-control input" id="fwzh_" name="fwzh_">
						</div>
					</td>
					<th style="width: 16%;">紧急程度</th>
					<td style="width: 16%;">
						<div class="form-group">
				...
				<tr>
					<th height="249">签发意见</th>
					<td colspan="5">
						<div class="form-group" style="word-break:break-all;overflow:auto;overflow-y:auto;height:249px;">
							<textarea class="form-control comment" id="commentQfyj_" name="commentQfyj_" style="background-color:white" rows="4"
				...
				<tr>
					<th height="249">审核意见</th>
					<td colspan="5">
						<div class="form-group" style="word-break:break-all;overflow:auto;overflow-y:auto;height:249px;">
							<textarea class="form-control comment" id="commentShyj_" name="commentShyj_" onpropertychange="if(value.length>2048) value=value.substr(0,2048)" style="background-color: white" rows="4" placeholder="">${submission.bur_instruction}</textarea>
