...
<body class="paper-outer">
	<div class="paper-inner">
		<form id="myFm">
			<p class="tablestyle_title" style="font-size:25pt">自由发文稿纸</p>
			...
			<table class="tablestyle" width="100%" border="0" cellspacing="0">
				...
				<tr>
					<th height="540">处理意见</th>
					<td colspan="3">
						<div class="form-group" style="word-break:break-all;overflow:auto;overflow-y:auto;height:540px;">
							<textarea class="form-control comment" id="commentBm_" name="commentBm_" onpropertychange="if(value.length>2048) value=value.substr(0,2048)" 
