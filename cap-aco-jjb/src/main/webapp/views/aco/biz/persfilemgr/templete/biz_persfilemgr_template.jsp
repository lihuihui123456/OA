...
<script type="text/javascript">
	...
	*
	*/
	function btn_save_persfile_info(pers_file_id){
		var userName_ = document.getElementById("form_iframe").contentWindow.getFieldVal("userName_");
		var user_sex = document.getElementById("form_iframe").contentWindow.getFieldVal("user_sex");
		var user_cert_code = document.getElementById("form_iframe").contentWindow.getFieldVal("user_cert_code");
		var marital_status = document.getElementById("form_iframe").contentWindow.getFieldVal("marital_status");
		var user_education = document.getElementById("form_iframe").contentWindow.getFieldVal("user_education");
		var user_police_type = document.getElementById("form_iframe").contentWindow.getFieldVal("user_police_type");
		$.ajax({
			type : "POST",
			url : "persFileController/doSavePersFileInfo",
			data:{
