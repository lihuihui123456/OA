...
/* 	function add() {
	...
	function add() { 
        /* var url="${ctx}/media/bpmplupload?chunk=false&url=${ctx}/media/upload?tableId=${tableId}";
...
<div class="panel-body">
	<div class="btn-group" role="group" aria-label="...">
		<button id="open" type="button" class="btn btn-default" onclick="openFile()" style="margin-bottom:5px;">
			<i class="fa fa-external-link"></i>&nbsp;打开
		</button>
		<button type="button" class="btn btn-default" onclick="add()" style="margin-bottom:5px;">
			<i class="fa fa-file-text"></i>&nbsp;上传
		</button>
		<button id="resave" type="button" class="btn btn-default" onclick="saveAs()" style="margin-bottom:5px;">
			<i class="fa fa-floppy-o"></i>&nbsp;另存
		</button>
		<button type="button" class="btn btn-default" onclick="del()" style="margin-bottom:5px;">
			<i class="fa fa-trash-o"></i>&nbsp;删除
		</button>
		<button type="button" class="btn btn-default" onclick="reName()" style="margin-bottom:5px;">
			<i class="fa fa-pencil"></i>&nbsp;重命名
		</button>
		<button type="button" class="btn btn-default"
			onclick="moveUpDown('up')" style="margin-bottom:5px;">
			<i class="fa fa-sort-up"></i>&nbsp;上移
		</button>
		<button type="button" class="btn btn-default"
			onclick="moveUpDown('down')" style="margin-bottom:5px;">
