...
function doSave(){
	...
	if (data) {
		...
		var solId = data[0].id;
		var url = "/bizRunController/getBizRunList/" + solId;
		closeDialog();
		window.parent.setUrl(url, inputId);
	}
}
...
function doUpdate(){
	...
	if(url != null && $.trim(url) != ""){
		...
		$.messager.alert('提示','url为空不能追加！','info');
	}
...
<body class="easyui-layout" style="width:100%;height:100%">
	...
	<!-- 页面布局中部 -->
	<div data-options="region:'center',title:'应用模型'">
		<!-- 列表工具栏 -->
		...
		<table class="easyui-datagrid" id="bizSolInfoList"
			...
			<thead>
				<tr>
					...
					<th data-options="field:'solName_',width:100">名称</th>
		...
		<div align="center" style="margin-top: 10px">
			<span> 
				<a href="javascript:void(0)" onclick="doSave()"
					class="easyui-linkbutton" plain="true">生成功能模块链接</a>
			</span> 
			<span> 
				<a href="javascript:void(0)" onclick="doUpdate()"
					class="easyui-linkbutton" plain="true">生成功能模块编号</a>
			</span> 
			<span> 
