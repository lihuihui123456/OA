...
<head>
	...
	<script type="text/javascript" src="${ctx}/views/cap/isc/org/js/selectOrgDeptPostUser.js"></script>
...
<body class="easyui-layout" style="width: 100%; height: 98%;"> 
	<div data-options="region:'west',split:true,collapsible:false" class="page_menu">
		...
		<div class="search-tree">
			...
			<ul class="easyui-tree" id="org_dept_post_tree" ></ul>
		</div>
	</div>
	...
	<div data-options="region:'center',iconCls:'icon-ok'" class="content">
		<div id="toolBar" class="clearfix">
			...
			<div id="operateBtn" class="tool_btn">
				<a href="javascript:void(0)" onclick="doSaveSelectUser()" class="easyui-linkbutton" iconCls="icon-save" plain="true">保存</a>
			</div>
		</div>
