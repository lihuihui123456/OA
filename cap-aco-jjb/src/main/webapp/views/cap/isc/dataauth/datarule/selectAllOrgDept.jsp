...
<head>
	...
	<script type="text/javascript" src="${ctx}/views/cap/isc/dataauth/datarule/js/selectAllOrgDept.js"></script>
	<style type="text/css">
		.choose_man{
			width:100%;
			height:50px;
...
<body class="easyui-layout" style="width: 100%; height: 96%;padding:10px"> 
	...
	<div data-options="region:'center',iconCls:'icon-ok'">
		...
		<!-- 部门列表 -->
		<table class="easyui-treegrid" id="deptList"></table>
	</div>
	<div data-options="region:'south'" style="height:30px;" id="southArea">
		<div class="choose_man" id="content"><span >已选部门：</span>
		</div>
	</div>
</body>
</html>