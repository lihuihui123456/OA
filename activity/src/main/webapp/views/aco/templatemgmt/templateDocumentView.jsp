 	...
 	function Load(){
 	  try{
		    ...
		    if(WebOffice.WebOpen()){                           //打开该文档    交互OfficeServer  调出文档OPTION="LOADFILE"
		    	WebOffice.setEditType("0");         //EditType:编辑类型  方式一   WebOpen之后
...
<form class="form-horizontal" id="iWebOfficeForm" method="post" action="">
	<div class="form-group">
		<label class="control-label col-lg-2 col-md-2 col-sm-2 col-xs-2">模板名：</label>
		<div class="col-lg-4  col-md-4 col-sm-4 col-xs-4">
			<input class="form-control input-sm" type="text" id="name_" name="name_" value="${template.name_}" readonly="readonly" maxlength="100"/>
		</div>
		<label class="control-label col-lg-2 col-md-2 col-sm-2 col-xs-2">说明：</label>
		<div class="col-lg-4  col-md-4 col-sm-4 col-xs-4">
			<input class="form-control input-sm"  type="text" id="remark_" name="remark_" value="${template.remark_}" readonly="readonly" maxlength="200"/> 
		</div>
