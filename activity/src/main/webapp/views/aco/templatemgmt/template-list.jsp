...
<script src="${ctx}/views/aco/templatemgmt/js/template-list.js"></script>
...
<body>
	...
	<div class="btn-div" id="search-div">
		<div class="input-group">
			<input type="text" id="input-word" class="form-control input-sm" value="请输入模板名称查询" 
				onFocus="if (value =='请输入模板名称查询'){value=''}" onBlur="if (value ==''){value='请输入模板名称查询'}"> 
...
function addTemp(){
	options={
			"text":"新增模板",
			"id":"template_add_",
			"href":"templateMgmt/templateDocumentEdit?encryption=1",
			"pid":window,
			"isDelete":true,
			"isReturn":true,
			"isRefresh":true
...
function printTempModel(){
	$("#printTemp").attr("src", "${ctx}/templateMgmt/toUploadFile");
	...
	if(reocrdId!=""){
		if(type==".doc"){
			options={
					...
					"href":"templateMgmt/templateDocumentView?recordId="+reocrdId,
					"pid":window,
					"isDelete":true,
					"isReturn":true,
					"isRefresh":true
