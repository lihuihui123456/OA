...
<title>页签详情表</title>
	...
	<script src="${ctx}/views/aco/circularize/js/filecylist.js"></script>
	...
	<div class="panel-body" style="padding-top:0;padding-bottom:0px;border:0;">
		<div id="toolbar" class="btn-group">
			<button id="btn_add" type="button" class="btn btn-default btn-sm">
				<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>拟稿
			</button>
			...
			<button id="btn_send" type="button" class="btn btn-default btn-sm">
				<span class="fa fa-share-square-o" aria-hidden="true"></span>发送
			</button>
		</div>
