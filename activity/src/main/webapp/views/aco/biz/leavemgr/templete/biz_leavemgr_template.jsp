...
<script type="text/javascript">
	...
	*
	*/
	function btn_save_leave_info(leaveId){
		var leaveState = "1";
		var leaveType = document.getElementById("form_iframe").contentWindow.getFieldVal("leave_type");
		var startTime = document.getElementById("form_iframe").contentWindow.getFieldVal("rest_time");
		var endTime = document.getElementById("form_iframe").contentWindow.getFieldVal("rest_time_end");
		var leaveDayNum = document.getElementById("form_iframe").contentWindow.getFieldVal("qingjia_days");
		var is_bj = document.getElementById("form_iframe").contentWindow.getFieldVal("leave_capital");
		var is_exit = document.getElementById("form_iframe").contentWindow.getFieldVal("leave_country");
		$.ajax({
			type : "POST",
			url : "leaveController/doSaveLeaveInfo",
			data:{
				"leaveId":leaveId,
