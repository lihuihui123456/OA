...
<!-- 						<div class="form-group" id="dialog-message">
	...
	<div id="upperSearch" class="search-high-grade" style="display: none;">
		<form id="search_form" enctype="multipart/form-data" class="form-horizontal "
			...
			<div class="form-group" >
							<label class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label">来文单位</label>
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
								<input id="lwdw" name="lwdw" type="text" class="form-control input-sm" >
							</div>
	                     <label class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label">来文文号</label>
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
								<input id="number" name="number" type="text" class="form-control input-sm" >
							</div>
						</div>
			<div class="form-group">
	...
	<table id="bizInfoList">
		<thead>
			<tr>
				...
				<th data-align="center" data-valign="middle" data-field="operate" data-width="80px" data-events="operateEvents" data-formatter="operateFormatter" >操作</th>
			</tr>
		</thead>
	</table>
		<div class="swiper-container">
