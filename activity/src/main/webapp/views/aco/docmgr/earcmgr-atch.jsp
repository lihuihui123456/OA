...
function attachFile(){
	$('#myModal').modal('show');
	$('#group').attr("src","${ctx}/media/toDoEarcList?bizid=${bizid}&&bizid_attach='"+bizid_attach+"'");
	//清除数据
	bizid_attach='';
}
        ...
        success: function(data) {
	        ...
	        if(data != null) {
	        	for(var i=0;i<data.length;i++){
		        	htm+='<div style="font-size:14px;color:blue;padding:3px 0;text-decoration:underline;cursor:pointer;" onclick="connect(\''+data[i].bizid_attach+'\',\''+ data[i].solId +'\',\''+data[i].procInstId+'\')">'+ data[i].attach_title+' </div>'
...
<body class="paper-outer" style="margin-top:-15px\9">
	...
	<table class="tablestyle" width="100%" border="0" cellspacing="0">
		<tr>
			<th height="880">调阅档案信息</th>
			<td height="880" style="word-break:break-all;overflow:auto;padding-top:10px;vertical-align:top;padding-left:20px">
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title" id="myModalLabel">调阅档案信息</h3>
				</div>
