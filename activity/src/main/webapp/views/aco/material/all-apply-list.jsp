...
<script src="${ctx}/views/aco/material/js/all-apply-list.js"></script>
...
<body>
	...
	<!-- 		<button id="gm_btn_view" type="button" class="btn btn-default btn-sm">
			...
			<button id="gm_btn_true" type="button" class="btn btn-default btn-sm">
				<span class="fa fa-check" aria-hidden="true"></span>通过
			</button>

			<button id="gm_btn_false" type="button" class="btn btn-default btn-sm">
