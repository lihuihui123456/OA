...
<script src="${ctx}/views/aco/material/js/edit-material-apply.js"></script>
			...
			<div class="main" style="padding-left: 20px;padding-top: 20px;background-color:#fff;">
				<form id="ff" action="" method="post" enctype="multipart/form-data"
					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							<textarea id="reason" name="reason_" rows="4" class="form-control">${data.reason_ }</textarea>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-11">
							<textarea id="remark" name="remark_" rows="4" class="form-control">${data.remark_ }</textarea>
						</div>
					</div>
				</form>
