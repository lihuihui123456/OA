...
<script src="${ctx}/views/aco/meetingroom/js/roomused-list.js"></script>
...
<div class="panel-body"  style="padding-top: 0px;padding-bottom:0px;border:0;">
	...
	<!-- 高级查询 -->
	<div id="searchDiv" class="search-high-grade" style="display:none;margin-top: 40px;">
		<form class="form-horizontal" id="search_form" style="width: 90%;">
			<div class="form-group">
				<label class="control-label col-lg-2 col-md-2 col-sm-2 col-xs-2" style="font-weight: bolder;">会议标题</label>
				<div class="col-lg-4  col-md-4 col-sm-4 col-xs-4">
					<input class="form-control input-sm" type="text" id="meeting_name"
						name="meeting_name">
				</div>				
				<label class="control-label col-lg-2 col-md-2 col-sm-2 col-xs-2" style="font-weight: bolder;">会议室</label>
				<div class="col-lg-4  col-md-4 col-sm-4 col-xs-4">
			...
			<div class="form-group">
				<label class="control-label col-lg-2 col-md-2 col-sm-2 col-xs-2" style="font-weight: bolder;">开始时间</label>
				<div class="col-sm-4">
					<input type="text" id="start_time" name="start_time"
						class="form-control select input-sm"
						onclick="laydate({istime: true, format: 'YYYY-MM-DD',isclear: true})" />
				</div>			
				<label class="control-label col-lg-2 col-md-2 col-sm-2 col-xs-2" style="font-weight: bolder;">到</label>
				<div class="col-sm-4">
			...
			<div class="form-group">
				<label class="control-label col-lg-2 col-md-2 col-sm-2 col-xs-2" style="font-weight: bolder;">申请人</label>
				<div class="col-lg-4  col-md-4 col-sm-4 col-xs-4">
				...
				<form id="ff" action="" method="post"
					...
					<div class="row">
						<div class="form-group  col-sm-12">
							...
							<div class="col-md-3">
								<input type="text" id="starttime1" name="starttime"
