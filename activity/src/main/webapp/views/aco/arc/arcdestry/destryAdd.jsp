	...
	<div class="panel-body">
		...
		<div id="tabsH">
			...
			<div class="tab-content" id="panel_box">
				<div role="tabpanel" class="tab-pane active" id="destryIframe">
					<iframe src="${ctx}/arcDestry/goToForm" id="form_iframe" runat="server"  
...
<script src="${ctx}/views/aco/arc/arcdestry/js/destryAdd.js"></script>
<script>
/**
 * 初始化加载监听窗口改变事件
 */
