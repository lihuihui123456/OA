...
<body class="paper-outer">
	<div class="paper-inner">
		<form id="destryForm" name="destryForm" >
			<p class="tablestyle_title" style="font-size:25pt">销毁档案登记稿纸</p>
			...
			<table class="tablestyle" width="100%" border="0" cellspacing="0">
				<tr>
					...
					<td>
						<div class="form-group">
							<input type="text" class="form-control input" id="nbr"
								name="nbr" value="${nbr}" readonly="readonly">
						</div>
					</td>
					<th>单号日期<span class="star">*</span></th>
					<td>
						<div class="input-group date" style="width: 100%">
							<input type="text" id="nbrTime" name="nbrTime" value="${timeNow}"
				...
				<tr>
					...
					<td colspan="2" style="border-right: #fff 1px solid;">
						<div class="form-group">
							<input type="text" title="点击查看档案基本信息" class="validate[required] form-control input"
								id="arcName" name="arcName" style="cursor:hand;text-decoration:underline"; onclick="viewArc()" unselectable="on">
						</div>
					</td>
					<td>
						<a href="javascript:void(0);" style="margin-left: 20px;" onclick="attachFile()">请选择销毁档案</a>
					</td>
				</tr>
				<tr>
					<th>有效期</th>
					<td colspan="3">
						<div class="form-group">
							<input type="text" class="validate[required] form-control input" id=expiryDate name="arcExpiryDate">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class="form-group date">
								<input type="text" id="operTime" name="operTime" value="${timeNow }"
								style="width: 100%" class="validate[required] form-control input"
								onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" />
...
<script src="${ctx}/views/aco/arc/arcdestry/js/destryAdd_form.js"></script>
</html>