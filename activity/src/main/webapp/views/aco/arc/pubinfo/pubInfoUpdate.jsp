		...
		<div id="tabsH">
			...
			<ul id="myTabs" class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a
					href="#pubInfoformUpdate" role="tab" data-toggle="tab"
					id="dengji_update">登记信息</a></li>
			...
			<div class="tab-content" id="panel_box">
				<div role="tabpanel" class="tab-pane active" id="pubInfoformUpdate">
					<iframe
						src="${ctx}/pubInfo/goToFormUpdate?id=${typeId}&pId=${pId}&arcId=${arcId}"
...
<script src="${ctx}/views/aco/arc/pubinfo/js/pubInfoUpdate.js"></script>
<script>
/**
 * 初始化加载监听窗口改变事件
 */
