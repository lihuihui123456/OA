	...
	<div class="panel-body">
		...
		<div id="tabsH">
			...
			<ul id="myTabs" class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a href="#pubinfoform"
					role="tab" data-toggle="tab" id="dengji">登记信息</a></li>
			...
			<div class="tab-content" id="panel_box">
				<div role="tabpanel" class="tab-pane active" id="pubinfoform">
					<iframe src="${ctx}/pubInfo/goToForm?id=${typeId}&pId=${pId}"
...
<script src="${ctx}/views/aco/arc/pubinfo/js/pubInfoAdd.js"></script>
<script>
/**
 * 初始化加载监听窗口改变事件
 */
