...
<script src="${ctx}/views/aco/arc/arcbid/list/js/arcbid-list.js"></script>
<!-- end -->
<!-- 滑动start -->
...
<script type="text/javascript">
	 ...
	 */
	 function expExcel(){
			//判断是否有选中
			var obj = $('#arcBidList').bootstrapTable('getSelections');
			if (obj.length!=''||obj.length==1) {
				...
				$("#selectIds").val("");
					...
					if($("#input-word").val()!="请输入项目名称查询"&&$("#input-word").val()!=""){
						var bidName=$("#input-word").val();
						$("#search_form")[0].reset();
						$("#bidName").val(bidName);
					}
					 window.location.href = "${ctx}/arcBidController/exportBidExcel?"+$("#search_form").serialize();
					if($("#input-word").val()!="请输入项目名称查询"&&$("#input-word").val()!=""){
						 $("#bidName").val("");
					}		
	 }
			...
			<form class="form-horizontal" id="search_form">
				...
				<div class="form-group">
					...
					<div class="col-lg-4  col-md-4 col-sm-4 col-xs-4">
						<input class="form-control input-sm" type="text" id="bidName"
							name="bidName" placeholder="请输入项目名称" style="margin-left: -50px;">
					</div>
						<label class="control-label col-lg-2 col-lg-2 col-md-2 col-sm-2 col-xs-2">中标单位:</label>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						<input class="form-control input-sm" type="text" id="bidCo"
							name="sproName" placeholder="请输入中标单位" style="margin-left: -50px;">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-lg-2 col-md-2 col-sm-2 col-xs-2">登记日期:</label>
					<div class="col-lg-4  col-md-4 col-sm-4 col-xs-4">
					...
					<label class="control-label col-lg-2 col-lg-2 col-md-2 col-sm-2 col-xs-2">年度:</label>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
		...
		<div class="modal-dialog" style="width: 700px">
			...
			<form class="form-horizontal" id="search_form">
				...
				<div class="form-group">
					...
					<label class="control-label col-lg-2 col-lg-2 col-md-2 col-sm-2 col-xs-2">年度:</label>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
<!-- 						<input class="form-control input-sm" type="text" id="searchregYear"
							name="searchregYear" placeholder="请输入年度" style="margin-left: -50px;"> -->
							<select class="form-control input-sm selectpicker" id="searchregYear"
								name="searchregYear" value="" title="请选择年度" style="margin-left: -50px;">
								<option value=""></option>
						</select>
