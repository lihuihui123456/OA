		...
		<form id="arcIntlForm" name="arcIntlForm">
			...
			<table class="tablestyle" width="100%" border="0" cellspacing="0">
				...
				<tr>
					...
					<td colspan="3">
							<div class="form-group">
							<input type="text" class="form-control input" id="docNbr" name="docNbr">
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3">
							<div class="form-group">
							<input type="text" class="validate[required] form-control input" id="agrNbr" name="agrNbr">
						</div>
					</td>
				</tr>
				<tr>
