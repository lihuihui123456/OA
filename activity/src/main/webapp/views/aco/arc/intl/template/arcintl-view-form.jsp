...
<script type="text/javascript">
	$(function() {
		$("input,select,textarea", $("form[name='arcDclrForm']")).attr(
				'readonly', true);
		...
		$("#docNbr").val('${bean.docNbr}');
		$("#agrNbr").val('${bean.agrNbr}');
	});
...
<body class="paper-outer">
	<div class="paper-inner">
		<form id="arcDclrForm" name="arcDclrForm">
			<p class="tablestyle_title" style="font-size:25pt">内部项目档案登记单</p>
			...
			<table class="tablestyle" width="100%" border="0" cellspacing="0">
				<tr>
					...
					<td><input id="regUser" name="regUser"
						class="form-control select" type="text"
						style="width: 100%; height: 29; border: 0;" /></td>
					<th>登记部门<span class="star">*</span></th>
					<td><input id="regDept" name="regDept"
						class="form-control select" name="draft_depart_name" type="text"
						style="width: 100%; height: 29; border: 0;" /></td>
				</tr>
				<tr>
					<th>登记日期</th>
					<td><input type="text" id="regDate" name="regDate"
						style="width: 100%" class="form-control select" /></td>
					<th>档案类型</th>
					<td><input type="text" id="arcType" name=""
						arcType"" style="width: 100%" class="form-control select" /></td>
				</tr>
				<tr>
					<th>文号</th>
					<td colspan="3">
						<div class="form-group">
							<input type="text" class="form-control input" id="docNbr"
								name="docNbr">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td colspan="3">
						<div class="form-group">
							<input type="text" class="form-control input" id="arcName"
								name="arcName">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td colspan="3">
						<div class="form-group">
							<input type="text" class="form-control input" id="proName"
								name="proName">
						</div>
					</td>
				</tr>
				<tr>
					<th>协议编号<span class="star">*</span></th>
					<td colspan="3">
						<div class="form-group">
							<input type="text" class="form-control input" id="agrNbr"
								name="agrNbr">
						</div>
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="3">
						<div class="form-group">
							<input type="text" class="form-control input" id="remarks"
								name="remarks">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td colspan="3">
						<div class="form-group">
							<input type="text" class="form-control input" id="expiryDate"
								name="expiryDate">
						</div>
					</td>
				</tr>
				...
				<tr>
					<th>归档人</th>
					<td><input type="text"
						class="form-control input" id="fileUser"
						name="fileUser"></td>
					<th>归档日期</th>
					<td colspan="3">
						<div class="input-group date" style="width: 100%">
							<input type="text" class="form-control input" id="fileTime"
								name="fileTime">
						</div>
					</td>
				</tr>
