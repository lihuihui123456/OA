...
<body id="conBody" style="overflow:hidden;">
	...
	<div class="panel-body">
		...
		<input type="hidden" id="typeId" name="type" value='${typeId}'>
		<div id="tabsH">
			<!-- 页签头 -->
			...
			<div role="tabpanel" class="tab-pane" id="attachment">
				<iframe id="attachment_iframe" src="" runat="server" width="100%" frameborder="no" border="0" scrolling="yes"></iframe>
			</div>
			</div>
			<!-- tab页签内容结束 -->
		</div>
...
<script src="${ctx}/views/aco/arc/intl/template/js/arcintl-index.js"></script>
