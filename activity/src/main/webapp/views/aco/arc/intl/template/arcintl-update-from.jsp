...
<script src="${ctx}/views/aco/arc/intl/template/js/arcintl-form.js"></script>
<script src="${ctx}/views/aco/dispatch/js/deptData.js"></script>
<script type="text/javascript">
var expiryDate = '${bean.expiryDate}';
</script>
<style>
.btn-default {
	color: #333;
...
$(function() {
	$("#arcName").focus();
	if(type=="addFile"){
		$("input,select,textarea",$("form[name='arcIntlForm']")).attr("disabled","disabled");
	}
...
<body class="paper-outer">
	<div class="paper-inner">
		<form id="arcIntlForm" name="arcIntlForm">
			...
			<table class="tablestyle" width="100%" border="0" cellspacing="0">
				<tr>
					...
					<td>
						...
						<input id="draftUserIdName_" name="regUser"
							...
							readOnly="true" onclick="peopleTree(1,'draftUserId_')"; 
					...
					<td>
						<div class="input-group date" style="width: 100%">
							<input type="text" id="regTime" name="regTime" style="width: 100%"
								class="validate[required] form-control select" value='<fmt:formatDate value='${bean.regTime}'  pattern='yyyy-MM-dd HH:mm:ss'/>'
				...
				<tr>
					...
					<td colspan="3">
							<div class="form-group">
							<input type="text" class="form-control input" value='${bean.docNbr}' id="docNbr" name="docNbr">
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3">
							<div class="form-group">
							<input type="text" class="validate[required] form-control input" value='${bean.agrNbr}' id="agrNbr" name="agrNbr">
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3">
							<div class="form-group">
							<input type="text" class="form-control input" id="remarks" value='${bean.remarks}' name="remarks">
						</div>
					</td>
				</tr>
				<tr>
