		...
		<div id="tabsH">
			...
			<ul id="myTabs" class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active">
					<a href="#mtgsummform" role="tab" data-toggle="tab" id="dengji">登记信息</a>
				</li>
			...
			<div class="tab-content" id="panel_box" >
				<div role="tabpanel" class="tab-pane active" id="mtgsummform">
					<iframe src="${ctx}/arcMtgSumm/goToForm?id=${typeId}&pId=${pId}" id="form_iframe" runat="server"  
						width="100%" frameborder="no" border="0" scrolling="yes"></iframe>
				</div>
<!-- 				<div role="tabpanel" class="tab-pane" id="attachment" class="overflow-y:auto;" >
					 ...
					 <div class="paper-outer">
						...
						<table class="tablestyle" width="100%" border="0" cellspacing="0">
							<tr>
								...
								<td>
									<iframe id="attachment_iframe" runat="server"
									src="${ctx}/media/bpmaccessory?docType=2&showType=form&tableId="
									width="100%"  frameborder="no" border="0"
								...
								<th>会议图片</th>
								<td>
									<iframe id="attachment_iframe1" runat="server"
									src="${ctx}/media/bpmaccessory?docType=hytp&showType=form&tableId="
									width="100%"  frameborder="no" border="0"
									scrolling="yes"></iframe>
								</td>
							</tr>
								...
								<th>其他附件</th>
								<td>
									<iframe id="attachment_iframe2" runat="server"
									src="${ctx}/media/bpmaccessory?docType=qtfj&showType=form&tableId="
									width="100%"  frameborder="no" border="0"
									scrolling="yes"></iframe>
								</td>
							</tr>
...
<script src="${ctx}/views/aco/arc/mtgsumm/js/mtgSummAdd.js"></script>
<script>
/**
 * 初始化加载监听窗口改变事件
 */
