...
<body id="conBody" style="overflow:hidden;">
	...
	<div class="panel-body">
	    <input type="hidden" value="${addFuJian}" id="addFuJian" />
		...
		<div  id="tabsH">
			...
			<ul id="myTabs" class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active">
					<a href="#mtgsummformUpdate" role="tab" data-toggle="tab" id="dengji_update">登记信息</a>
				</li>
			...
			<div class="tab-content" id="panel_box">
				<div role="tabpanel" class="tab-pane active" id="mtgsummformUpdate">
					<iframe src="${ctx}/arcMtgSumm/goToFormUpdate?id=${typeId}&pId=${pId}&arcId=${arcId}" id="form_iframe" runat="server"  
						width="100%" frameborder="no" border="0" scrolling="yes"></iframe>
				</div>
				<div role="tabpanel"  id="attachment">
					<div class="paper-outer" id="attachment_body" style="height:100%">
...
<script src="${ctx}/views/aco/arc/mtgsumm/js/mtgSummUpdate.js"></script>
<script>
/**
 * 初始化加载监听窗口改变事件
 */
