...
<script src="${ctx}/views/aco/arc/arcdclr/template/js/arcdclr-form.js"></script>
...
$(function() {
	$("#arcName").focus();
	if(type=="addFile"){
		$("input,select,textarea",$("form[name='arcDclrForm']")).attr("disabled","disabled");
	}
			...
			<table class="tablestyle" width="100%" border="0" cellspacing="0">
				<tr>
					...
					<td>
						...
						class="validate[required] select" 
						readOnly="true" name="draft_depart_name" type="text"
				...
				<tr>
					...
					<td>
						<div class="input-group date" style="width: 100%">
							<input type="text" id="decTime" name="decTime" style="width: 100%"
								class="form-control select"  value='<fmt:formatDate value='${bean.decTime}'  pattern='yyyy-MM-dd HH:mm:ss'/>'
								onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" />
						</div>
					</td>
					<th>承担部门</th>
					<td>
						<div class="form-group">
							<input type="text" class="form-control input" value='${bean.bearDept}' id="bearDept" name="bearDept">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class="form-group">
							<input type="text" class="form-control input" value='${bean.decUser}' id="decUser" name="decUser">
						</div>
					</td>
					<th>资助金额（万元）<span class="star">*</span></th>
					<td>
							<div class="form-group">
							<input type="text" class="form-control input" value='${bean.decMny}' id="decMny" name="decMny">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td colspan="3">
						<div class="form-group">
							<input type="text" class="form-control input" value='${bean.proCom}' id="proCom" name="proCom">
						</div>
					</td>
				</tr>
				<tr>
