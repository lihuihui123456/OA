...
function formatterOpert (val, row, index){
	return '<table border="0" width="100%"><tr>'
			...
			+'<td><img style="cursor:pointer" src="../views/cap//bpm/bizsolmgr/img/mgr.png" title="方案配置" onclick="imgClick(\''+index+'\',\'fapz\')"/></td>'
			+'<td><img style="cursor:pointer" src="../views/cap//bpm/bizsolmgr/img/icon-start.png" title="启动流程" onclick="imgClick(\''+index+'\',\'qdlc\')"/></td>'
