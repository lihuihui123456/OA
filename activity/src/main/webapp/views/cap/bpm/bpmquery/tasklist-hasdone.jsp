...
<script src="${ctx}/views/cap/bpm/bpmquery/js/tasklist-hasdone.js"></script>
...
<body>
	...
	<div id="upperSearch" class="search-high-grade" style="display: none;">
				<form id="ff" enctype="multipart/form-data" class="form-horizontal "
					...
					<div class="form-group" id="dialog-message">
						<label class="col-lg-1 col-md-1 col-sm-1 col-xs-1 control-label">办理时间</label>
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" style="text-align: center;">
					...
					<div>
						<button class="btn btn-primary" onclick="makesureFolder()">确定</button>
	...
	oInit.Init = function() {
		...
		$("#grgd").click(function(){
			...
			if(bizid==""){
				...
				/* $('#myModal').modal('show');
				$('#group').attr("src","${ctx}/docmgt/toMngFolderTree"); */
				makesureFolder();
			}
		});
...
function makesureFolder(){
	...
	var bizid=getselectoption();
	document.getElementById("group").contentWindow.btnOk();
