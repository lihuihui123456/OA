	...
	<div class="history">
		<div class="start-history">
			...
			<div class="history_left">
				...
				<p class="history_L yearalmostr">
					...
					<b class="history_2006_b yellow">
						<span class="history_l_month">09<br />月</span>
						<span class="history_l_text">CC视频发布视频云<br />开放战略及API2.0</span> </b>
				</p>
				<p class="history_L yearalmostr">
			...
			<div class="history-img">
				<!--<img class="history_img" src="${ctx}/static/cap/plugins/time/images/history.png" alt="">-->
			</div>
			<div class="history_right">
				...
				<p class="history_R history_r_2005" style="background:url(${ctx}/static/cap/plugins/time/images/R_frist.png) no-repeat -1px -1px;">
					...
					<b class="history_2005_b">
						...
						<span class="history_r_text">CC视频成立<br />并入住北京大学留学生创业园</span> </b>
				</p>
				...
				<p class="history_R yearalmostr">
					<span class="history_2005_span blue">2011</span>、
					<b class="history_2005_b blue_R"> <span class="history_r_month">11<br />月
					</span><span class="history_r_text">CC视频荣获<br />“最佳云服务模式奖”</span>
					</b>
				</p>
				<p class="history_R yearalmostr">
