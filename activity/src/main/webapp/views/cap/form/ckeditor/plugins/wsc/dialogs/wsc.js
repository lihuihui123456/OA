...
(function() {
    ...
    var J = function(b) {
        var c, e, d;
        for (d in b) c = (c = a.dialog.getContentElement(a.dialog._.currentTabId, d)) ? c.getElement() : b[d].instance.getElement().getFirst() || b[d].instance.getElement(),
        e = b[d].localizationID || d,
        c.setText(a.LocalizationComing[e])
    },
    K = function(b) {
        var c, e, d;
        for (d in b) c = a.dialog.getContentElement(a.dialog._.currentTabId, d),
        c || (c = b[d].instance),
        c.setLabel && (e = b[d].localizationID || d, c.setLabel(a.LocalizationComing[e] + ":"))
    },
    r,
    A;
    ...
    a.buildOptionLang = function(b, c) {
        ...
        if (0 === e.options.length) {
            ...
            k.sort();
            for (var p = 0; p < k.length; p++) f = document.createElement("option"),
    ...
    var B = function(a) {
        ...
        k.style.cssText = "position: absolute;top:30px;bottom:41px;left:1px;right:1px;z-index: 10020;padding:0;margin:0;background:" + a + ";opacity: " + f + ";filter: alpha(opacity\x3d" + 100 * f + ");display: none;";
        k.id = d;
        h || e.appendChild(k);
        return {
            setDisable: function() {
    ...
    O = {
        ...
        grammerSuggest: function(b) {
            ...
            for (var c = b.length,
            e = !0,
            d = 0; d < c; d++) a.grammerSuggest.getElement().append(L(b[d], b[d], e)),
            e = !1;
            v();
            a.div_overlay.setDisable()
        },
        thesaurusSuggest: function(b) {
            ...
            for (var d in b) b = document.createElement("option"),
            b.text = d,
            b.value = d,
            c.$.add(b, e),
            e++;
        ...
        ReplaceText: function(b) {
            ...
            a.div_overlay.setEnable();
            a.dataTemp = b.text;
            a.selectingLang = b.currentLang; (b.cmd = "0" !== b.len && b.len) ? a.div_overlay.setDisable() : window.setTimeout(function() {
                try {
                    a.div_overlay.setDisable()
                } catch(b) {}
            },
    ...
    function(b) {
        function c(a) {
            ...
            a._.moved || (q = isNaN(c) && isNaN(d) ? 0 : 1, isNaN(c) && (c = (m.width - n.width) / 2), 0 > c && (c = 0), c > m.width - n.width && (c = m.width - n.width), isNaN(d) && (d = (m.height - n.height) / 2), 0 > d && (d = 0), d > m.height - n.height && (d = m.height - n.height), a.move(c, d, q))
        }
        function e() {
            b.wsc = {}; (function(a) {
                var b = {
        ...
        return {
            ...
            onShow: function() {
                ...
                if (CKEDITOR && CKEDITOR.config) {
                    ...
                    d = b.config.wsc_customLoaderScript || d + "//loader.webspellchecker.net/sproxy_fck/sproxy.php?plugin\x3dfck2\x26customerid\x3d" + a.wsc_customerId + "\x26cmd\x3dscript\x26doc\x3dwsc\x26schema\x3d22";
                    c(this);
                    ...
                    function(c) {
                        ...
                        b.plugins.scayt && (b.wsc.isSsrvSame = function() {
                            ...
                            g,
                            p;
                            window.SCAYT && window.SCAYT.CKSCAYT && (f = SCAYT.CKSCAYT.prototype.basePath, f.split("//"), g = f.split("//")[1].split("/")[0], p = f.split(g + "/")[1].replace("/lf/scayt3/ckscayt/", "") + "/script/ssrv.cgi"); ! d || f || b.config.scayt_servicePath || (d.split("//"), e = d.split("//")[1].split("/")[0], h = d.split(e + "/")[1].replace("/lf/scayt3/ckscayt/ckscayt.js", "") + "/script/ssrv.cgi");
    ...
    function(b) {
        ...
        return {
                            ...
                            },
                            {
                                ...
                                children: [{
                                    ...
                                    children: [{
                                        ...
                                        onShow: function() { (this.getElement().getFirst() || this.getElement()).setText(a.LocalizationComing.Create)
                                        },
                                        onClick: b
                                    },
                                    {
                                        ...
                                        onShow: function() { (this.getElement().getFirst() || this.getElement()).setText(a.LocalizationComing.Restore)
                                        },
                                        onClick: b
                                    }]
                                },
                                {
                                    ...
                                    children: [{
                                        ...
                                        onShow: function() { (this.getElement().getFirst() || this.getElement()).setText(a.LocalizationComing.Rename)
                                        },
                                        onClick: b
                                    },
                                    {
                                        ...
                                        onShow: function() { (this.getElement().getFirst() || this.getElement()).setText(a.LocalizationComing.Remove)
                                        },
                                        onClick: b
                                    }]
                                }]
            ...
            onLoad: function() {
                ...
                e.IgnoreDomainNames = c.getContentElement("OptionsTab", "IgnoreDomainNames")
            },
            onShow: function() {
                ...
                parseInt(d.IgnoreMixedCaseWords, 10) ? e.IgnoreMixedCaseWords.setValue("checked", !1) : e.IgnoreMixedCaseWords.setValue("", !1);
