...
<script type="text/javascript"
	src="${ctx}/views/cap/form/js/formuserrole.js"></script>
			...
			<td style="padding:10px;">
				<table id="tb_rule_${index.index }" name="asstable"
					...
					data-options=" iconCls: 'icon-edit', singleSelect: true, toolbar: '#btn_${index.index }',
				                url: '${ctx}/formUserRuleController/getRulelist?colid=${col.col_id}', method: 'get', 
				...
				<div id="btn_${index.index }" style="height:auto">
					<a href="javascript:void(0)" class="easyui-linkbutton"
						...
						onclick="append('tb_rule_${index.index }','${col.col_id}','${col.table_id}')">添加</a> <a
