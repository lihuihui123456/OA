$(function() {
	...
	if (mIsExsitRId == 'true' || mIsExsitRId == true || e_pdf == '1') {
	...
	$("#saveFile").click(function() {
		try {
			...
			iWebPDF2015.COMAddins("KingGrid.MsgServer2000").Object.WebUrl = mServerUrl;
			...
			iWebPDF2015.COMAddins("KingGrid.MsgServer2000").Object.SetMsgByName("USERNAME", "");
			iWebPDF2015.COMAddins("KingGrid.MsgServer2000").Object.SetMsgByName("USERNAME", mfileName);
			iWebPDF2015.COMAddins("KingGrid.MsgServer2000").Object.SetMsgByName("RECORDID", mRecordID);
			iWebPDF2015.COMAddins.Item("KingGrid.MsgServer2000").Object.SetMsgByName("FILENAME", mfileName);
	...
	$("#openURLFile").click(function() {
		try {
			iWebPDF2015.Documents.OpenFromURL("");
			addState("打开成功");
		} catch (e) {
			addState("打开失败");
			alert(e.description);
	...
	$("#saveLocalFile").click(function() {
		try {
			...
			iWebPDF2015.Documents.ActiveDocument.Save("c://test.pdf");
	...
	$("#GetCurrentPageNo").click(function() {
		try {
			...
			var PageNo = iWebPDF2015.Documents.ActiveDocument.Views.ActiveView.PageNum;
			var nPageCount = iWebPDF2015.Documents.ActiveDocument.Pages.Count;
			alert("本文档共有" + nPageCount + "页，当前页是" + PageNo
					+ "页");
	...
	$("#GoToPage").click(function() {
		try {
			...
			iWebPDF2015.Documents.ActiveDocument.Views.ActiveView.PageNum = PageNo;
			var info;
			if (PageNo > iWebPDF2015.Documents.ActiveDocument.Pages.Count
					|| PageNo < 1) {
				info = "页码错误,跳转失败！";
				alert(info);
			} else {
	...
	$("#GoToPageFirst").click(function() {
		try {
			...
			iWebPDF2015.Documents.ActiveDocument.Views.ActiveView.PageNum = 1;
			addState("跳转到首页！");
		} catch (e) {
			addState("跳转失败！");
			alert(e.description);
	...
	$("#GoToPageLast").click(function() {
		try {
			...
			var nPageCount = iWebPDF2015.Documents.ActiveDocument.Pages.Count;
			iWebPDF2015.Documents.ActiveDocument.Views.ActiveView.PageNum = nPageCount;
	...
	$("#RoateView").click(function() {
		try {
			...
			var Roate = iWebPDF2015.Documents.ActiveDocument.Views.ActiveView.Rotation;
			alert(Roate);
			Roate = Roate + 90;
			alert(Roate);
			iWebPDF2015.Documents.ActiveDocument.Views.ActiveView.Rotation = 90;
			iWebPDF2015.Documents.ActiveDocument.Views.ActiveView
					.Refresh();
			alert(iWebPDF2015.Documents.ActiveDocument.Views.ActiveView.Rotation);
			addState("视图旋转成功！");
		} catch (e) {
			addState("视图旋转失败！");
			alert(e.description);
	...
	$("#IsAllowAnnotMove").click(function() {
		try {
			...
			var pages = iWebPDF2015.Documents.ActiveDocument.Pages;
	...
	$("#addPage").click(function() {
		try {
			...
			if (!iWebPDF2015.Documents.ActiveDocument
					.HasPermissions(1)) {
			...
			var Res;
			if (nClick % 2) {
				Res = iWebPDF2015.Documents.ActiveDocument.Pages
						.Add(592, 842, 0, 0);
			} else {
				Res = iWebPDF2015.Documents.ActiveDocument.Pages
						.Delete(1);
	...
	$("#addAnnotText").click(function() {
		try {
			...
			var annot = iWebPDF2015.Documents.ActiveDocument.Pages
					.Item(0).Annots.Add(0);
			...
			// 自定义批注信息
			annot
					.SetCustomEntry("AnnotInfo",
							"\"type\":\"Text\",\"filename\":\"hehe\",\"author\":\"TK\"");
	...
	$("#HideShowNavBar").click(function() {
		try {
			...
			if (0 == (nClick % 2)) {
				...
				iWebPDF2015.Options.TabBarVisible = true;
			}
			addState("隐藏/显示标签页成功。");
		} catch (e) {
			addState("隐藏/显示标签页失败。");
	...
	$("#SwitchLanguage").click(function() {
		try {
			nClick++;
			if (1 == (nClick % 4)) {
				iWebPDF2015.Options.Lcid = 2052;

			} else if (2 == (nClick % 4)) {
				iWebPDF2015.Options.Lcid = 1028;

			} else if (3 == (nClick % 4)) {
				iWebPDF2015.Options.Lcid = 3076;

			} else if (0 == (nClick % 4)) {
				iWebPDF2015.Options.Lcid = 1033;
	...
	$("#HideShowTabCommandBar").click(function() {
		try {
			...
			if (0 == (nClick % 2)) {
				...
				iWebPDF2015.Options.TabCommandBarVisible = true;
			}
	...
	$("#HideShowPrint").click(function() {
		try {
			...
			// 得到CommandBar的数量
			nClick++;
			var nCBCount = iWebPDF2015.CommandBars.Count;
			for (var i = 0; i < nCBCount; i++) {
				if ("File" == iWebPDF2015.CommandBars.Item(i).Name) {
					var nCtlsCount = iWebPDF2015.CommandBars
							.Item(i).Controls.Count;
					for (var j = 0; j < nCtlsCount; j++) {
						var Ctrls = iWebPDF2015.CommandBars
								.Item(i).Controls;
	...
	$("#HideShowBar").click(function() {
		try {
			...
			var nCount = iWebPDF2015.CommandBars.Count;
			nClick++;
			for (var i = 0; i < nCount; i++) {
				if (0 == (nClick % 2)) {
					iWebPDF2015.CommandBars.Item(i).Visible = false;
				} else {
					iWebPDF2015.CommandBars.Item(i).Visible = true;
				}
			}
			addState("隐藏工具栏成功。");
		} catch (e) {
	...
	$("#HideShowNavigation").click(function() {
		try {
			...
			iWebPDF2015.Documents.ActiveDocument.Window.DisplayLayout = bVisible;
			iWebPDF2015.Documents.ActiveDocument.Window.DisplayNavigation = bVisible;
			addState("隐藏导航栏成功。");
		} catch (e) {
			addState("隐藏导航栏失败。");
			alert(e.description);
	...
	/*
	 * function InsertImage() { if ( 0 == iWebPDF2015.Documents.Count ) {
	 * alert("没有已打开文档"); retrun; } Var annot =
	 * iWebPDF2015.Documents.ActiveDocument.Pages(0).Annots.Add(12);
	 * annot.FromDeviceRect(100,100,200,200); annot.BlendMode = "Multiply";
	 * annot.Title = "Admin"; annot.Color = 255;
	...
	$("#Watermark").click(function() {
		try {
			...
			iWebPDF2015.Documents.ActiveDocument.Pages.Item(0).Refresh();
			iWebPDF2015.Documents.ActiveDocument.Views.ActiveView.Refresh();
			addState("添加水印成功");
		} catch (e) {
			addState("添加水印失败。");
	...
	$("#WatermarkPic").click(function() {
		try {
			...
			var annot = iWebPDF2015.Documents.ActiveDocument
					.Pages(0).Annots.Add(25);
			if (annot) {
				...
				annot
						.ImageAppearance("http://www.kinggrid.com/img/logo.jpg");
				annot.UpdateAppearance();
			}
			iWebPDF2015.Documents.ActiveDocument.Pages.Item(0)
					.Refresh();
			iWebPDF2015.Documents.ActiveDocument.Views.ActiveView
					.Refresh();
			addState("添加水印成功");
	...
	$("#addPictureAnnot").click(function() {
		try {
			...
			var annot = iWebPDF2015.Documents.ActiveDocument
					.Pages(0).Annots.Add(12);
			annot.FromUserRect(300, 700, 400 + 93 * 72 / 96,
					700 + 74 * 72 / 96);
			annot.BlendMode = "Multiply";
			annot.Title = "TK";
			annot.Color = 255;
			...
			annot
					.SetCustomEntry("AnnotInfo",
							"\"type\":\"Stamp\",\"filename\":\"Pic\",\"author\":\"TK\"");
			iWebPDF2015.Documents.ActiveDocument.Views.ActiveView
					.Refresh();
			addState("添加图片批注成功");
		} catch (e) {
	...
	$("#getAnnotCount").click(function() {
		try {
			...
			var nAnnot = iWebPDF2015.Documents.ActiveDocument.Pages
					.Item(0).Annots.Count;
	...
	$("#PrintNormal").click(function() {
		try {
			...
			// 参数5 后台打印 boolean
			var Missing;
			iWebPDF2015.Documents.ActiveDocument.PrintOut(Missing,
					Missing, 15, 1, false);
			addState("打印成功。");
		} catch (e) {
			addState("打印失败。");
	...
	$("#SplitFile").click(function() {
		try {
			...
			if (iWebPDF2015.Documents.ActiveDocument.Pages.Count <= 1) {
				alert("只有一页文档，无法分割！");
				return;
			}
			var strFile = "c:\\split.pdf";
			var res = iWebPDF2015.Documents.ActiveDocument.Pages
					.Extract(strFile, "2");
			if (!res) {
				alert("分割文件成功,文件名:" + strFile);
				iWebPDF2015.Documents.ActiveDocument.Close();
				iWebPDF2015.Documents.Open(strFile);
			}
	...
	function() {
		try {
			...
			var FilePath = iWebPDF2015.Documents.ActiveDocument.FileInformation.FileLocation;
			var FileName = iWebPDF2015.Documents.ActiveDocument.FileInformation.FileName;
			var FullPath = FilePath + FileName;

			iWebPDF2015.Documents.ActiveDocument.Pages
					.AddPageFromFile(FullPath, 0, "1");
			addState("插入文件成功！");
		} catch (e) {
			addState("插入文件失败！");
			alert(e.description);
	...
	$("#MergFile").click(function() {
		try {
			...
			var result = iWebPDF2015.Documents.Merge(MergFile,
					FullPath, Missing, FullPath, Missing);
			if (!result) {
				iWebPDF2015.Documents.Open(MergFile);
			}
			addState("合并文件成功！");
		} catch (e) {
			addState("合并文件失败！");
	...
	$("#addAttchments").click(function() {
		try {
			...
			iWebPDF2015.COMAddins("KingGrid.iWebPDF2015").Object
					.AddAttachments("C://test.pdf", "test.pdf")
			addState("添加附件成功。");
		} catch (e) {
			addState("添加附件失败。");
			alert(e.description);
	...
	$("#AddDelAttchments").click(function() {
		try {
			...
			nClick++;
			if (nClick % 2) {
				res = iWebPDF2015.Documents.ActiveDocument.Attachments
						.Add("c:\\Windows\\win.ini", "win.ini");
				if (!res)
					alert("附件添加成功！");
			} else {
				res = iWebPDF2015.Documents.ActiveDocument.Attachments
...
function SaveDocument() {
	// add by lzw 保存正文前先判断业务信息是否保存（此方法仅用于公文模块）
	//window.parent.changeIseb();
	var flag = false;
	try {
		// 在线保存文档
		if (0 == iWebPDF2015.Documents.Count) {
			...
			iWebPDF2015.COMAddins("KingGrid.MsgServer2000").Object.WebUrl = mServerUrl;
			var tempFile = iWebPDF2015.COMAddins("KingGrid.MsgServer2000")
				.Object.CreateTempFileName();
			iWebPDF2015.Documents.ActiveDocument.Save(tempFile);
			iWebPDF2015.COMAddins("KingGrid.MsgServer2000").Object.MsgFileLoad(tempFile);
			iWebPDF2015.COMAddins("KingGrid.MsgServer2000").Object.SetMsgByName("DBSTEP", "DBSTEP");
			iWebPDF2015.COMAddins("KingGrid.MsgServer2000").Object.SetMsgByName("OPTION", "SAVEFILE");
...
// 打开文档
function WebOpen() {
	iWebPDF2015.COMAddins.Item("KingGrid.MsgServer2000").Object.WebUrl = mServerUrl;
	var tempFile = iWebPDF2015.COMAddins.Item("KingGrid.MsgServer2000").Object.CreateTempFileName();
	iWebPDF2015.COMAddins.Item("KingGrid.MsgServer2000").Object.SetMsgByName("DBSTEP", "DBSTEP");
	iWebPDF2015.COMAddins.Item("KingGrid.MsgServer2000").Object.SetMsgByName("OPTION", "LOADFILE");
	iWebPDF2015.COMAddins.Item("KingGrid.MsgServer2000").Object.SetMsgByName("FILETYPE", "PDF");
	iWebPDF2015.COMAddins.Item("KingGrid.MsgServer2000").Object.SetMsgByName("USERNAME", "演示人");
	iWebPDF2015.COMAddins.Item("KingGrid.MsgServer2000").Object.SetMsgByName("RECORDID", mRecordID);
	iWebPDF2015.COMAddins.Item("KingGrid.MsgServer2000").Object.SetMsgByName("FILENAME", mfileName);
	if (iWebPDF2015.COMAddins.Item("KingGrid.MsgServer2000").Object.PostDBPacket(false)) {
		iWebPDF2015.COMAddins.Item("KingGrid.MsgServer2000").Object.MsgFileSave(tempFile);
...
function openUrlFile(url) {
	try {
		iWebPDF2015.Documents.OpenFromURL(url);	
