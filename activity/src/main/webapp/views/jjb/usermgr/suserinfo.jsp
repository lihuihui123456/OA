...
<div style="width: 100%">
	<form id="ff" action="" method="post" enctype="multipart/form-data"
		...
		<div >
			<div class="form-group col-sm-6"
				style="margin-left: 0; margin-right: 0">
				<label class="col-sm-4 control-label" for="entryTime">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;实习时间</label>
				<div class="col-sm-8">
			...
			<div class="form-group has-feedback col-sm-6"
				...
				<div class="col-sm-8">
					<input type="text" id="userSeniority" name="userSeniority"
						value="${userInfo.userSeniority }" class="form-control input-sm" placeholder="" maxlength=32>
				</div>
			</div>
		</div>
		<div >
		...
		<div >
			<div class="form-group has-feedback col-sm-6"
				style="margin-left: 0; margin-right: 0">
				<label class="col-sm-4 control-label" for="deptName">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;实习部门</label>
				<div class="col-sm-8">
			...
			<div class="form-group has-feedback col-sm-6"
				style="margin-left: 0; margin-right: 0">
				<label class="col-sm-4 control-label" for="postName">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;实习职务</label>
				<div class="col-sm-8">
